...
public class IndexOrNameDataListener extends AnalysisEventListener<IndexOrNameData> {
    ...
    private IndexOrNameDemoDao demoDao;

    /**
     * 如果使用了spring,请使用这个构造方法。每次创建Listener的时候需要把spring管理的类传进来
     * @param demoDao
     */
    public IndexOrNameDataListener(IndexOrNameDemoDao demoDao) {
     ...
     */
    @Override
    public void invoke(IndexOrNameData demoData, AnalysisContext analysisContext) {
